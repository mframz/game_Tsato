...
var Game8 = {
 preload: function() {
            ...
            game.load.image("bg5","assets/daan3.png");
            ...
            game.load.image("level9", 'assets/level9.png');
            game.load.image("door", 'assets/door.png',process.start8);
 ...
 create: function() {
            ...
            btn = game.add.button(280,180,"door",process.start8);
            btn.fixedToCamera = true;

            text = game.add.image(180,10, "level9");
            ...
            scoreText = game.add.text(10,8,"Score: 0/290",{fill:"gray", font:'25px Cooper Black', stroke: 'black', strokeThickness:4});
...
game.state.add("Game8" ,Game8, false);