...
var Game7 = {
 preload: function() {
            ...
            game.load.image("bg5","assets/daan.png");
            ...
            game.load.image("level8", 'assets/level8.png');
            game.load.image("door", 'assets/door3.png',process.start7);
 ...
 create: function() {
            ...
            btn = game.add.button(280,180,"door",process.start7);
            btn.fixedToCamera = true;

            text = game.add.image(180,10, "level8");
            ...
            scoreText = game.add.text(10,8,"Score: 0/260",{fill:"gray", font:'25px Cooper Black', stroke: 'black', strokeThickness:4});
...
game.state.add("Game7" ,Game7, false);