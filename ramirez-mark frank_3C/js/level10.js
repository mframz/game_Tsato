...
var Game9 = {
 preload: function() {
            ...
            game.load.image("level10", 'assets/level10.png');
            game.load.image("door", 'assets/door2.png',process.start9);
 ...
 create: function() {
            ...
            btn = game.add.button(280,180,"door",process.start9);
            btn.fixedToCamera = true;

            text = game.add.image(180,10, "level10");
            ...
            scoreText = game.add.text(10,8,"Score: 0/1000",{fill:"gray", font:'25px Cooper Black', stroke: 'black', strokeThickness:4});
...
game.state.add("Game9" ,Game9, false);