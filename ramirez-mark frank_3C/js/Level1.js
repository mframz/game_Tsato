...
var Game = {
 preload: function() {
            ...
            game.load.image("door", 'assets/door.png',process.start);
            ...
            game.load.audio("soundeffects","music/soundeffect2.mp3");
 ...
 create: function() {
            ...
            btn = game.add.button(280,180,"door",process.start);
            btn.fixedToCamera = true;

            text = game.add.image(180,10, "level1");
            ...
            // player.body.bounce.y = 0.99;


            game.physics.arcade.enable(taya);
            taya.body.collideWorldBounds = true;

            scoreText = game.add.text(10,8,"Score: 0/50",{fill:"gray", font:'25px Cooper Black', stroke: 'black', strokeThickness:4});
