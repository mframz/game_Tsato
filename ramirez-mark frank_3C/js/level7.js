...
var Game6 = {
 preload: function() {
            ...
            game.load.image("bg2","assets/burol.png");
           	game.load.image("bg3","assets/ulap.png");
            game.load.image("bg4","assets/puno.png");
            game.load.image("bg5","assets/daan2.png");
            ...
            game.load.image("level7", 'assets/level7.png');
            game.load.image("door", 'assets/door2.png',process.start6);
 ...
 create: function() {
            ...
            btn = game.add.button(280,180,"door",process.start6);
            btn.fixedToCamera = true;

            text = game.add.image(180,10, "level7");
            ...
            scoreText = game.add.text(10,8,"Score: 0/230",{fill:"gray", font:'25px Cooper Black', stroke: 'black', strokeThickness:4});
...
game.state.add("Game6" ,Game6, false);