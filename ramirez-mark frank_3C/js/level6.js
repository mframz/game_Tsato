...
var Game5 = {
 preload: function() {
            ...
            game.load.image("bg1","assets/bundok2.png");
            game.load.image("bg2","assets/burol2.png");
           	game.load.image("bg3","assets/ulap3.png");
            game.load.image("bg4","assets/puno2.png");
            game.load.image("bg5","assets/daan6.png");
            ...
            game.load.image("stick","assets/stick2.png");
            game.load.image("level6", 'assets/level6.png');
            game.load.image("door", 'assets/door2.png',process.start5);
 ...
 create: function() {
            ...
            btn = game.add.button(280,180,"door",process.start5);
            btn.fixedToCamera = true;

            text = game.add.image(180,10, "level6");
            ...
            player.animations.add('walk-left',[8,9,10,11],7,true);
             ...
             process.createPlakas(7000);
            plaka = game.add.group();
            plaka.enableBody = true;

            process.createSticks(10000);
            ...
            scoreText = game.add.text(10,8,"Score: 0/200",{fill:"gray", font:'25px Cooper Black', stroke: 'black', strokeThickness:4});
...
game.state.add("Game5" ,Game5, false);