...
var Game2 = {
 preload: function() {
            ...
            game.load.image("door", 'assets/door3.png',process.start2);
 ...
 create: function() {
            ...
            btn = game.add.button(280,180,"door",process.start2);
            btn.fixedToCamera = true;

            text = game.add.image(180,10, "level3");
            ...
            scoreText = game.add.text(10,8,"Score: 0/110",{fill:"gray", font:'25px Cooper Black', stroke: 'black', strokeThickness:4});
...
game.state.add("Game2" ,Game2, false);