...
var Game1 = {
 preload: function() {
            ...
            game.load.image("door", 'assets/door2.png',process.start1);
 ...
 create: function() {
            ...
            btn = game.add.button(280,180,"door",process.start1);
            btn.fixedToCamera = true;

            text = game.add.image(180,10, "level2");
            ...
            scoreText = game.add.text(10,8,"Score: 0/80",{fill:"gray", font:'25px Cooper Black', stroke: 'black', strokeThickness:4});
