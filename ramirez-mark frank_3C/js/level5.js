...
var Game4 = {
 preload: function() {
            ...
            game.load.image("bg4","assets/puno3.png");
            game.load.image("bg5","assets/daan5.png");
            ...
            game.load.image("door", 'assets/door3.png',process.start4);
 ...
 create: function() {
            ...
            btn = game.add.button(280,180,"door",process.start4);
            btn.fixedToCamera = true;

            text = game.add.image(180,10, "level5");
            ...
            scoreText = game.add.text(10,8,"Score: 0/170",{fill:"gray", font:'25px Cooper Black', stroke: 'black', strokeThickness:4});
...
game.state.add("Game4" ,Game4, false);